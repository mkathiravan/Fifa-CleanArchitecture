...
package com.example.kathir.fifa_cleanarchitecture.domain.usecase;
...
public class GetFifaTeamByFlag extends UseCase<Team> {

  private final Repository repository;
  private String flag = "";

  @Inject public GetFifaTeamByFlag(@Named("executor_thread") Scheduler executorThread,
